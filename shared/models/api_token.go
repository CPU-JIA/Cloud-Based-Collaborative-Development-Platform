...
var SystemAPIScopes = []APIScope{
	...
	},
	{
		...
		Category:    "projects",
		Resources:   []string{"projects", "tasks", "sprints"},
		Actions:     []string{"read", "list"},
		IsSystem:    true,
	},
	{
	...
	},
	{
		...
		Category:    "projects",
		Resources:   []string{"projects", "tasks", "sprints", "members"},
	...
	},
	{
		...
		Resources:   []string{"repositories", "commits", "branches"},
		Actions:     []string{"read", "list", "clone"},
		IsSystem:    true,
	},
	{
		Name:        "repos:write",
		...
		Category:    "repositories",
		Resources:   []string{"repositories", "commits", "branches"},
		Actions:     []string{"push", "create_branch", "merge"},
		IsSystem:    true,
	},
	{
		Name:        "repos:admin",
		...
		Category:    "repositories",
		Resources:   []string{"repositories", "commits", "branches", "hooks", "settings"},
	...
	},
	{
		...
		Category:    "cicd",
		Resources:   []string{"pipelines", "builds", "deployments"},
		Actions:     []string{"read", "list"},
		IsSystem:    true,
	},
	{
		...
		Category:    "cicd",
		Resources:   []string{"pipelines", "builds"},
		Actions:     []string{"trigger", "cancel"},
		IsSystem:    true,
	},
	{
		Name:        "cicd:admin",
		...
		Category:    "cicd",
		Resources:   []string{"pipelines", "builds", "deployments", "runners"},
		Actions:     []string{"create", "read", "update", "delete", "manage"},
		IsSystem:    true,
	},
	{
	...
	},
	{
		...
		Category:    "knowledge",
		Resources:   []string{"documents", "pages", "attachments"},
	...
	},
	{
		...
		Category:    "knowledge",
		Resources:   []string{"documents", "pages", "attachments"},
		Actions:     []string{"create", "update", "upload"},
		IsSystem:    true,
	},
	{
		Name:        "admin:read",
		...
		Category:    "admin",
		Resources:   []string{"tenants", "settings", "logs", "metrics"},
		Actions:     []string{"read", "list"},
		IsSystem:    true,
	},
	{
		...
		Category:    "admin",
		Resources:   []string{"tenants", "settings", "users", "permissions"},
		Actions:     []string{"create", "update", "manage"},
		IsSystem:    true,
	},
}
